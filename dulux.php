...
<body>
    <section class="dulux-items">
        <h1 id="jk">DULUX PAINTS</h1>
        <div class="all-items">
            <?php
            @include 'config.php';
            $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE type='dulux'");
    ...
    <div id="site">
        ...
        <button id="b1" onclick='window.open("https:\/\/www.dulux.in")'>Visit dulux.html.com</button>
    </div>
</body>
</html>