...
<body>
    <section class="asian-items">
        <h1 id="jk">ASIAN PAINTS</h1>
        <div class="all-items">
            <?php
            @include 'config.php';
            $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE type='asianpaints'");
    ...
    <div id="site">
        ...
        <button id="b1" onclick='window.open("https:\/\/www.asianpaints.com")'>Visit AsianPaints.com</button>
    </div>
</body>
</html>